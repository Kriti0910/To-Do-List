    ...
    return (
        <>
            <form onSubmit={submitHandler} className="input-group my-3">
                <input ref={input} name='todoInput' autoComplete='off' value={inputText} onChange={inputHandler} type="text" className="p-2 form-control" placeholder="Add the Tasks" aria-label="Recipient's username" aria-describedby="button-addon2"/>
